...
- Video Vault with one validated repo-bundled, parent-approved local narrated
  clip, a Parent Panel observation launch, and a manual handoff to a separate
  three-picture vocabulary response.
...
- Run the first parent-started video/response observation with the child and
  record a parent note before adding vocabulary breadth or delayed review.
