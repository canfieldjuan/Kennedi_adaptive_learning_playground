...
import kennedisOrdersPinkCupcake from './activities/kennedis-orders-pink-cupcake-001.json';
import kennedisOrdersThreeBerries from './activities/kennedis-orders-three-berries-001.json';
...
export const APPROVED_ACTIVITIES: LearningActivity[] = [
  ...
  kennedisOrdersPinkCupcake,
  kennedisOrdersThreeBerries,
